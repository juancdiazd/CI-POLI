...
<html lang="en">
  <head>
	...
	<body onload="document.form1.name.focus()">
		...
		<h3>To import a pre-defined contest, just fill in the import file field.</h3>
		<form name="form1" enctype="multipart/form-data" method="post" action="importxml.php">
			<input type=hidden name="confirmation" value="noconfirm" />
			<label for="localsite">Local site number:</label>
			<?php
			...
			?>
			<label for="localsite">	Encryption Key::</label>
